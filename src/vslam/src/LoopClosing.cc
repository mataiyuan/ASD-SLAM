...
void LoopClosing::Run()
{
    ...
    while(1)
    {
		...
		{
		   cout<<" ComputeSim3  false"<<endl;
		}
            }
	    else
	     {
		cout<<"DetectLoop() false"<<endl; 
             }
        }
	else
	{
		cout<<"keyframes in the queue are empty"<<endl;
	}
...
bool LoopClosing::DetectLoop()
{
    ...
    cout<<" mpCurrentKF  minScore::"<<minScore<<endl;
...
bool LoopClosing::ComputeSim3()
{
    ...
    ORBmatcher matcher(0.85,true);////////!!!!!!!!!!!!!!!!!!!!!!!之前是0.75
